...
class PythonPullStageImplementation (IMotorStageImplementation):
    ...
    def AdjustBeginningStageParameters(self, recent_behavior_sessions, current_session_stage):
        ...
        if total_hits >= 50 and total_hits < 100:
            position = current_session_stage.Position.InitialValue + 0.25
        elif total_hits >= 100 and total_hits < 150:
            position = current_session_stage.Position.InitialValue + 0.50
        elif total_hits >= 150 and total_hits < 200:
            position = current_session_stage.Position.InitialValue + 0.75
        elif total_hits >= 200 and total_hits < 250:
            position = current_session_stage.Position.InitialValue + 1.00
        elif total_hits >= 250 and total_hits < 300:
            position = current_session_stage.Position.InitialValue + 1.25
        elif total_hits >= 300:
            position = current_session_stage.Position.InitialValue + 1.50
